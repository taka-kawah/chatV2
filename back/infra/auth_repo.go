...
func (d *AuthDriver) Create(email string, hashedPassword string) *AuthRepositoryError {
...
func (d *AuthDriver) CheckIfExist(email string, hashedPassword string) (*domain.Auth, *AuthRepositoryError) {
...
func (d *AuthDriver) DeleteAuth(email string, hashedPassword string) *AuthRepositoryError {
	var auth domain.Auth
